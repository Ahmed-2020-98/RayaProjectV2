...
export default function Large_Appliances() {
                    ...
                    <div className="row d-flex flex-column">
                        ...
                        <div className="row col-12">
                            <div className="d-flex justify-content-center">
                                <h1 className="pageHeader">LARGE APPLIANCES</h1>
                            </div>
                            <div className=" mb-5">
                            ...
                            <div className="d-flex flex-wrap">
                                ...
                                <div className="ProductCard flex-grow-1 d-flex flex-column shadow bg-white mx-3 my-2 position-relative" style={{ width: "17rem" }}>
                                    ...
                                    <div className="my-4 d-flex justify-content-center">
                                        <img src="https://api-rayashop.freetls.fastly.net/media/catalog/product/cache/4e49ac3a70c0b98a165f3fa6633ffee1/w/w/ww70t4020cx1as_2.jpg" alt='Samsung' loading="lazy" className="ProductCard__Thumb object-contain grow mt-5" />
                                    </div>
